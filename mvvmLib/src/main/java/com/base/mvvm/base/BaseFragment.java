...
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseView {
    ...
    public void onAttach(Activity activity) {
        LanguageUtils.attachBaseContext(activity);
    ...
    private void initNetState() {
        ...
        NetStatesController.Companion.getINSTANCE().bind(activity);
    }
    ...
    private void unBindNetState() {
        ...
        NetStatesController.Companion.getINSTANCE().unBind(activity);
    }
