package com.base.mvvm.http.interceptor.logging;
...
class Printer {
    ...
    static void printJsonRequest(LoggingInterceptor.Builder builder, Request request) {
        ...
        if (builder.getLogger() == null){
            ExecutorRequestServiceHolder.executorRequestService.execute(() -> {
    ...
    private static final class ExecutorRequestServiceHolder {
        static final ExecutorService executorRequestService = Executors.newSingleThreadExecutor();
    }
