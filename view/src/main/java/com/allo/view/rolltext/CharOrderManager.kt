package com.allo.view.rolltext

import com.allo.view.rolltext.strategy.CharOrderStrategy
import com.allo.view.rolltext.strategy.Direction
import com.allo.view.rolltext.strategy.NormalAnimationStrategy


internal class CharOrderManager {

    var charStrategy: CharOrderStrategy = NormalAnimationStrategy()
