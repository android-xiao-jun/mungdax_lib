...
public class CaptureButton extends View {
    ...
    private final int progress_color = 0xFF438EFF;            //进度条颜色
    ...
    interface CountDownCallBack {
        void countDown(int countDownTime);
        void stop();
    }
...
//                }
    ...
    private void updateProgress(long millisUntilFinished) {
        ...
        invalidate();
        Log.e("===z","recorded_time=" + (int)(millisUntilFinished / (float) duration * 60f));
        if (mCountDownCallBack != null) {
            mCountDownCallBack.countDown((int)(millisUntilFinished / (float) duration * 60f));
        }
    }
