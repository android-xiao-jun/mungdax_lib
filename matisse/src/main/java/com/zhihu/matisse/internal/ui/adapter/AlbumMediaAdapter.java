...
public class AlbumMediaAdapter extends
    ...
    private ClickCaptureImageListener captureImageListener;
        ...
        if (viewType == VIEW_TYPE_CAPTURE) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    captureImageListener.onClickCaptureImage(v);
                }
            });
            return holder;
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof CaptureViewHolder) {
            ...
            if (!LanguageUtils.isZh()){
                captureViewHolder.mHint.setTypeface(ResourcesCompat.getFont(holder.itemView.getContext(),R.font.ukijtor));
            }
    ...
    public void setCaptureImageListener(ClickCaptureImageListener captureImageListener) {
        this.captureImageListener = captureImageListener;
    }

    public interface ClickCaptureImageListener {
        void onClickCaptureImage(View v);
    }
