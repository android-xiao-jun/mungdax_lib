...
public class AlbumsSpinner {
    ...
    public AlbumsSpinner(@NonNull Context context) {
        ...
        mListPopupWindow.setBackgroundDrawable(AppCompatResources.getDrawable(context,R.drawable.shape_bottom_10_white_solid));
    ...
    public void setSelectedTextView(TextView textView) {
        ...
        mSelected.setTypeface(ResourcesCompat.getFont(textView.getContext(), LanguageUtils.isZh() ? com.allo.view.R.font.han_sans : com.allo.view.R.font.ukijtor));
