...
public class CheckView extends View {
    ...
    private void init(Context context) {
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.ic_checkbox_checked, context.getTheme());
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCountable) {
            ...
            if (mChecked) {
                initBackgroundPaint();
//                canvas.drawCircle((float) dpToPx(SIZE) / 2, (float) dpToPx(SIZE) / 2,
//                        dpToPx(BG_RADIUS), mBackgroundPaint);
