...
public final class SelectionCreator {
     ...
     * 是否需要展示自定义相机拍摄 默认不需要
     *
     * @param needCameraX 需要CameraX
     * @return 是
     */
    public SelectionCreator needCameraX(boolean needCameraX) {
        mSelectionSpec.needCameraX = needCameraX;
        return this;
    }

    /**
     * 是否展示只看一次按钮
     * @param needOnlyOne 需要needOnlyOne
     * @return 是
     */
    public SelectionCreator needOnlyOne(boolean needOnlyOne) {
        mSelectionSpec.needOnlyOne = needOnlyOne;
        return this;
    }
    ...
    public SelectionCreator cropCacheFolder(String cropCacheFolder) {
        mSelectionSpec.cropCacheFolder = cropCacheFolder;
        return this;
    }

    public SelectionCreator isCircleCrop(Boolean isCircle) {
        mSelectionSpec.isCircleCrop = isCircle;
        return this;
    }

    public SelectionCreator setApplyBtnText(CharSequence text) {
        mSelectionSpec.applyBtnText = text;
        return this;
    }
